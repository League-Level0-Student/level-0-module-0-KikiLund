...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("kiki_maze.png"));
	...
	public void update(int mouseColor,int x, int y) {
		mouseColor = maze.getRGB(x, y);
	}
	...
	public void mouseMoved(MouseEvent e) {
		...
		update(mouseColor,mouseX, mouseY);
	...
	private void scare() {
		...
		showScaryImage( "scary_clown.jpg");
